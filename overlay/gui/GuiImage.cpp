...
void GuiImage::internalInit(int w, int h)
{
    ...
    texCoords = NULL;
    vtxCount = 4;
    primitive = GX2_PRIMITIVE_QUADS;//ƒfƒtƒHƒ‹ƒg‚Ì}Œ`‚ÍŽlŠpŒ`
...
void GuiImage::draw2()//CVideo *pVideo)
{
	...
	if(imgType == IMAGE_COLOR && colorVtxs)
	{
        ...
        //GX2setAttributeBuffer NULL, NULL, 4
        ColorShader::instance()->setAttributeBuffer(colorVtxs, posVtxs, vtxCount);
    ...
    else if(imageData)//“ü—Í‚ªŽÊ^‚Ì‚Æ‚«‚Ìˆ—
	{
